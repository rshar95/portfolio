      ...
      <div id="intro">
        <Typist avgTypingDelay={120}>
          <span className="intro-title">
            {"you've reached "}
            <span className="intro-name">{"Richa"}</span>
          </span>
        </Typist>
        <FadeInSection>
          <div className="intro-subtitle">Let's quickly get entangled!
          <svg fill="#64ffda" height="50px" width="50px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" stroke="#64ffda">
              ...
              <g id="SVGRepo_iconCarrier">
                  ...
                  <g>
                      <g><polygon points="274.734,244.921 255.6,233.938 236.522,245.017 236.577,267.079 255.71,278.062 274.789,266.983 "></polygon></g>
                  </g>
              </g>
          </svg>
          ...
          <div className="intro-desc">
            I'm a Quantum Physicist and Founder based in New York.<br></br>Currently developing
            <a href="https://flutrai.com/">{" "}FlutrAI: Disrupting the way we invest in Fashion</a>, which tackles the <a href='https://www.genevaenvironmentnetwork.org/resources/updates/sustainable-fashion/'>{" "}fundamental issues in the Fashion Industry{" "}</a> for e.g supply-chains,excessive carbon footprints,and unrecycled waste which is estimated to be over
            $500 Billion.
          </div>
          <a
            href="mailto:founder@flutrai.com"
